...
- (void)addLayer:(CGFloat)size{
    ...
    PQVoiceTopArcView *circleView1 = [[PQVoiceTopArcView alloc]initWithFrame:self.bounds lineWidth:self.lineWidth*2 lindeColor:[UIColor colorWithRed:162/255.0 green:214/255.0 blue:184/255.0 alpha:1] size:size];
